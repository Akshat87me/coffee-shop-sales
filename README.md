...
Small (30%)
8. Filtering Options
Users can filter data based on day and month to focus on specific time periods and better analyze trends in sales and footfall.
Technologies Used
Data Visualization: Created with tools like Excel/Power BI/Tableau (specify based on what you used).
